  ...
  <div class="course-row">
    ...
    <div class="course-cell">
      <div class="message-group">
        ...
        <Message
          icon="pi pi-users"
          :severity="course.limit_enrollment > 0 ? 'secondary' : 'warn'"
          class="custom-message"
          >{{ `${course.limit_enrollment} 人` }}</Message
        >
        <Message
